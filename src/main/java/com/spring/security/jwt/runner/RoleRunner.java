    ...
    public void run(String... args) throws Exception {
        ...
        if (repository.count() == 0) {
            if (!repository.findByName(ERole.ROLE_USER).isPresent()) {
                ...
                customers.add(new Customer("Bob", "Smith", "1112223333", "789 Maple Ave", "north", "Chicago", "IL", 606001, "USA", "bobsmith", "bobsmith@email.com", passwordEncoder.encode("password"), Collections.singleton(user)));
